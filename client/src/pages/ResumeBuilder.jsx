...
const ResumeBuilder = () => {
  ...
  try {
    ...
    if (data.resume) {
      ...
      setResumeData({
        ...
        // ✅ FIXED
        accentColor: r.accentColor || '#3882F6',
  ...
  const saveResume = async () => {
    try {
      let updatedResumeData = typeof structuredClone === 'function' ?
        structuredClone(resumeData) : JSON.parse(JSON.stringify(resumeData))
          ...
          <div className='lg:col-span-7 max-lg:mt-6'>
            <div className='relative w-full'>
              <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                ...
                <button onClick={downloadResume} className='flex items-center px-6 py-2 gap-2 text-xs bg-gradient-to-br from-green-100 to-green-200 text-green-600 rounded-lg ring-green-300 hover:ring transition-colors'>
